      ...
      <section className="w-full lg:w-[50%] h-screen flex flex-col justify-center items-center bg-[#001219]">
        <div className="w-[80%] lg:w-[70%] md:p-6 mt-6 flex flex-col gap-8">
          ...
          <form className="flex flex-col gap-4">
            <Input label="Username" type="text" name="username" placeholder="Choose a username" />
            ...
            <button className="bg-[#0FA5AA] text-white p-2 rounded-lg w-full mt-5 transition-all duration-300 hover:bg-teal-600">
              Sign Up
            </button>

            <p className="text-center mt-4 text-gray-400">
              Already have an account?{" "}
              <Link href="/sign-in" className="text-[#0FA5AA] hover:underline">
                Sign in
              </Link>
            </p>
          </form>
